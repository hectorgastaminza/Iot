	        ...
	        <div class="container col-sm-8">
	               <h1 class="menu-title">ADD DEVICE</h1>
	                ...
	                <div class="form-group row">
	                    ...
	                    <div class="col-sm-10">
	                        <input type="text" class="form-control" name="deviceName" value="${deviceName}" placeholder="Enter device name">
	                    </div>
	                </div>
	                <div class="form-group row">
	                    <label for="description" class="col-sm-2 col-form-label">Description</label>
	                    <div class="col-sm-10">
	                        <input type="text" class="form-control" name="deviceDescription" value="${deviceDescription}" placeholder="Enter description">
	                    </div>
	                </div>
	                <div class="form-group row">
	                    <label for="id" class="col-sm-2 col-form-label">Device number</label>
	                    <div class="col-sm-10">
	                        <input type="number" min="0" max="254" class="form-control" aria-describedby="idHelp" name="deviceId" value="${deviceId}" placeholder="Enter device number">
